# Generated by Django 3.2 on 2022-04-14 08:20
...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.BigAutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('type', models.CharField(default='HOST', max_length=10, verbose_name='Типы')),
                ('body', models.TextField(blank=True, default='{}', null=True, verbose_name='Содержимое схемы')),
                ('updated', models.DateTimeField(auto_now_add=True, null=True, verbose_name='Дата изменения транзакции')),
                ('paramsschema', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='history', to='control.paramsschema')),
            ],
            options={
